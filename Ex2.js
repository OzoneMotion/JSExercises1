...
function timer() {
    let secondString = prompt("Put your timer (in seconds): ") * 1000
    let secondInt = parseInt(secondString, 10);
    console.log(typeof (secondInt))

    setTimeout(() => { alert(`Time for bed after  ${secondString / 1000}  seconds`); }, secondInt);
}
timer();
